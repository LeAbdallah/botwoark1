...
if (message.content === '^^support') {
      message.author.send(' |https://discord.gg/yjBfQ3| لـ أي استفسار').catch(e => console.log(e.stack));
...
if (message.content === '^^invite') {
      message.author.send(' رابط البوت |  https://discordapp.com/api/oauth2/authorize?client_id=543082377258336299&permissions=8&scope=bot ').catch(e => console.log(e.stack));
...
client.on('message', message => {
 if (message.content.startsWith("ترحيب 10")) {
  ...
  .setThumbnail(`${mentionavatar.avatarURL}`)
  .addField("***شكرا الانضمامك الينا***" ,mentionavatar.username )
  .setDescription('***مرحبا  بك يا صديكي.***')
...
client.login('NTQzMDgyMzc3MjU4MzM2Mjk5.Dz4ZdQ.bzYdwqIkyZRCdoTrwcPMS62sFHA');
